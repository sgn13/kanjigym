...
import FlatN4Json from '@/constants/flatn4.json';
...
export const N4Kanji = () => {
  ...
  const [questions, setQuestions] = useState<typeof FlatN4Json>([]);
  ...
  const options = useMemo(() => {
    ...
    return generateOptions(currentQuestion, FlatN4Json);
  }, [currentQuestion]);
  ...
  useEffect(() => {
    setQuestions(shuffle(FlatN4Json));
  }, []);
